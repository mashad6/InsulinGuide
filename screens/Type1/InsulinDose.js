      ...
      <View>
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity
            style={styles.list}
            onPress={() => {
              navigation.navigate("ten", { unit: 1 });
            }}
          >
          ...
          <TouchableOpacity
            style={styles.list}
            onPress={() => {
              navigation.navigate("ten", { unit: 2 });
            }}
          >
        ...
        <View style={{ flexDirection: "row" }}>
          <TouchableOpacity
            style={styles.list}
            onPress={() => {
              navigation.navigate("ten", { unit: 3 });
            }}
          >
          ...
          <TouchableOpacity
            style={styles.list}
            onPress={() => {
              navigation.navigate("ten", { unit: 4 });
            }}
          >
        ...
        <View style={{ flexDirection: "row", justifyContent: "center" }}>
          <TouchableOpacity
            style={styles.list}
            onPress={() => {
              navigation.navigate("ten", { unit: 5 });
            }}
          >
